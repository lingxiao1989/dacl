...
class FER2013Trainer(Trainer):
    ...
    def _train(self):
        ...
        for i, (images, targets) in tqdm(
            ...
            # for i, (images, targets) in  enumerate (self._train_loader):
    ...
    def _val(self):
        ...
        with torch.no_grad():
            ...
            # ):
            for i, (images, targets) in enumerate(self._val_loader):
                images = images.cuda(non_blocking=True)
                targets = targets.cuda(non_blocking=True)
    ...
    def _calc_acc_on_private_test(self):
        ...
        with torch.no_grad():
            ...
            # ):
            for i, (images, targets) in enumerate(self._test_loader):
                images = images.cuda(non_blocking=True)
                targets = targets.cuda(non_blocking=True)
